...
- The desktop form must not expose native Windows caption, sysmenu, thick-frame, minimize-box, or maximize-box styles. Activation/deactivation non-client painting should be suppressed so focus loss never draws a pale system title bar over the custom chrome.
